...
public class DashboardResource {
   ...
   private final DashboadService dashboadService;
    ...
    public ResponseEntity<DashboardDTO> carregarInfo(@RequestParam(name = "lojaId") final String lojaId,
        ...
        DashboardDTO dashboardDTO = dashboadService.carregarInformacoes(lojaId,  dtInicial, dtFinal);
